...
class ActorCritic(base.Agent):
    ...
    def __init__(
        ...
        def sgd_step(state: TrainingState,
            ...
            return (TrainingState(params=new_params, opt_state=new_opt_state), loss_actor, value_loss)
        ...
        if self._buffer.full() or new_timestep.last():
            ...
            def _calculate_gae(trajectory, last_val):
                def _get_advantages(gae_and_next_value, transition):
                    ...
                    discount, value, reward = (
                        ...
                        transition.value,
                        transition.rewards + state_action_reward_noise
                    )
            ...
            def _update_epoch(update_state, unused):
                def _update_minbatch(train_state, batch_info):
                    ...
                    self._state, actor_loss, value_loss = self._sgd_step(self._state, trajectory, state_action_reward_noise, advantages, targets)
...
def ppo_agent(obs_spec: specs.Array,
                  action_spec: specs.DiscreteArray,
                  config,
